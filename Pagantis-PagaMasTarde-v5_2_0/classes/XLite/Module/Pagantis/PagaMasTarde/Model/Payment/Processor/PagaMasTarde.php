...
namespace XLite\Module\Pagantis\PagaMasTarde\Model\Payment\Processor;
...
class PagaMasTarde extends \XLite\Model\Payment\Base\WebBased
{
    ...
    {
        return 'modules/Pagantis/PagaMasTarde/config.tpl';
    }
    ...
    {
        return 'modules/Pagantis/PagaMasTarde/payment.tpl';
    }
    ...
    protected function getFormFields()
    {
        ...
        $fields = array(
            ...
            'address[zipcode]'  => $this->getProfile()->getBillingAddress()->getZipcode(),
        ...
        $i=0;
        if ( $this->getOrder()->getSurchargeSumByType(\XLite\Model\Base\Surcharge::TYPE_SHIPPING) > 0) {   
            $fields["items[".$i."][quantity]"]= 1;
            $fields["items[".$i."][description]"]= 'Gastos de envio';
            $fields["items[".$i."][amount]"]= $this->getOrder()->getSurchargeSumByType(\XLite\Model\Base\Surcharge::TYPE_SHIPPING);
            $i++;
        }

        if ( $this->getOrder()->getSurchargeSumByType(\XLite\Model\Base\Surcharge::TYPE_TAX) > 0) {   
            $fields["items[".$i."][quantity]"]= 1;
            $fields["items[".$i."][description]"]= 'Impuestos';
            $fields["items[".$i."][amount]"]= $this->getOrder()->getSurchargeSumByType(\XLite\Model\Base\Surcharge::TYPE_TAX);
            $i++;
        }
        ...
        foreach ($this->getOrder()->getItems() as $item) {
            ...
            $fields["items[".$i."][description]"]  = substr($product->getName(), 0, 127);
